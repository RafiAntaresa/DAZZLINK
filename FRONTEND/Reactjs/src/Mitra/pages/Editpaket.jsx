  ...
  <Navbar  className="shadow p-3 mb-5 ">
                        ...
                        <div class="container ">
                            <div class="row">
                                ...
                                <div class="col"  >
                                <h5 class="card-title mt-1  fs-4 fw-semibold">Edit Paket Anda</h5>
                                </div>
                            </div>
                        </div>
                        </Navbar.Brand>
...
<label for="input">Nama Paket</label>
    <input type="text" class="form-control" id="inputHalfWidth" placeholder="Paket biasa"></input>
</div>
</div>

<div className="col-5"style={{marginLeft: '25rem' }}><div className="mb-3">
<label for="input">Waktu Pelayanan</label>
<input type="text" class="form-control" id="inputHalfWidth" placeholder="45 mnt"></input>
</div>
</div>

<div className="col-5"style={{marginLeft: '25rem' }}><div className="mb-3">
<label for="input">Harga</label>
<input type="password" id="pass" class="form-control" placeholder="Rp 30.000"></input>
</div>
</div>
<div className="col-5"style={{marginLeft: '25rem' }}><div className="mb-3">
<label for="input">Deskripsi</label>
<textarea class="form-control" aria-label="With textarea" placeholder="Cukur biasa"></textarea>
</div>
</div>
