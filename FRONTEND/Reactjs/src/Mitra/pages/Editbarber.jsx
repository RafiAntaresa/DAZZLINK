  ...
  <Navbar  className="shadow p-3 mb-5 ">
                        ...
                        <div class="container ">
                            <div class="row">
                                ...
                                <div class="col"  >
                                <h5 class="card-title mt-1  fs-4 fw-semibold">Edit Barber Anda</h5>
                                </div>
                            </div>
                        </div>
                        </Navbar.Brand>
...
<label for="input">Nama Barber</label>
            <input type="text" class="form-control" id="inputHalfWidth" placeholder="Agus"></input>
</div>
</div>
...
<div className="col-5"style={{marginLeft: '25rem' }}><div className="mb-3">
 <label for="input">Foto Barber</label>
            <div class="input-group mb-3">
             <input  type="text" class="form-control" placeholder="Fotoagus.jpeg" aria-label="Recipient's username" aria-describedby="button-addon2" ></input>
