     ...
     <div className="bg-light flex-fill">
        ...
        <div className="col-8"style={{marginLeft: '3rem' }}>
            ...
            <label for="input">Nama Bisnis</label>
                <input type="text" class="form-control" id="inputHalfWidth" placeholder="Arfa Barbershop"></input>
            </div>
            </div>
            ...
            <input type="text" class="form-control" id="inputHalfWidth" placeholder="0821271755327"></input>
            </div>
            </div>
            ...
            <div class="input-group mb-3">
             <input type="text" class="form-control" placeholder="ARFABARBERSHOP.JPG" aria-label="Recipient's username" aria-describedby="button-addon2"></input>
          <button class="btn" type="button" id="button-addon2" style={{backgroundColor: '#4F5C92' }}><svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20" fill="none">
            ...
            <textarea class="form-control" aria-label="With textarea" placeholder="SLEMAN,YOGYAKARTA"></textarea>
            </div>
            </div>
            <br></br>
            <br></br>
